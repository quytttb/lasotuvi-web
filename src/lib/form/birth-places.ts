...
export const BIRTH_PLACES: readonly BirthPlace[] = [
  ...
  // —— Đài Loan ——
  { id: "tw-taipei", country: "tw", label: "Đài Bắc", longitude: 121.57, latitude: 25.03, timezone: 8 },
  { id: "tw-new-taipei", country: "tw", label: "Tân Bắc", longitude: 121.47, latitude: 25.02, timezone: 8 },
  { id: "tw-keelung", country: "tw", label: "Cơ Long", longitude: 121.74, latitude: 25.13, timezone: 8 },
  { id: "tw-taoyuan", country: "tw", label: "Đào Viên", longitude: 121.3, latitude: 24.99, timezone: 8 },
  { id: "tw-hsinchu", country: "tw", label: "Tân Trúc", longitude: 120.97, latitude: 24.8, timezone: 8 },
  { id: "tw-miaoli", country: "tw", label: "Miêu Lật", longitude: 120.82, latitude: 24.56, timezone: 8 },
  { id: "tw-taichung", country: "tw", label: "Đài Trung", longitude: 120.67, latitude: 24.15, timezone: 8 },
  { id: "tw-changhua", country: "tw", label: "Chương Hóa", longitude: 120.53, latitude: 24.08, timezone: 8 },
  { id: "tw-nantou", country: "tw", label: "Nam Đầu", longitude: 120.68, latitude: 23.91, timezone: 8 },
  { id: "tw-yunlin", country: "tw", label: "Vân Lâm", longitude: 120.43, latitude: 23.71, timezone: 8 },
  { id: "tw-chiayi", country: "tw", label: "Gia Nghĩa", longitude: 120.45, latitude: 23.48, timezone: 8 },
  { id: "tw-tainan", country: "tw", label: "Đài Nam", longitude: 120.21, latitude: 22.99, timezone: 8 },
  { id: "tw-kaohsiung", country: "tw", label: "Cao Hùng", longitude: 120.31, latitude: 22.63, timezone: 8 },
  { id: "tw-pingtung", country: "tw", label: "Bình Đông", longitude: 120.49, latitude: 22.67, timezone: 8 },
  { id: "tw-yilan", country: "tw", label: "Nghi Lan", longitude: 121.75, latitude: 24.75, timezone: 8 },
  { id: "tw-hualien", country: "tw", label: "Hoa Liên", longitude: 121.61, latitude: 23.99, timezone: 8 },
  { id: "tw-taitung", country: "tw", label: "Đài Đông", longitude: 121.14, latitude: 22.76, timezone: 8 },
  { id: "tw-penghu", country: "tw", label: "Bành Hồ", longitude: 119.58, latitude: 23.57, timezone: 8 },

  // —— Trung Quốc (một số thành phố phổ biến) ——
  { id: "cn-beijing", country: "cn", label: "Bắc Kinh", longitude: 116.41, latitude: 39.9, timezone: 8 },
  { id: "cn-shanghai", country: "cn", label: "Thượng Hải", longitude: 121.47, latitude: 31.23, timezone: 8 },
  { id: "cn-guangzhou", country: "cn", label: "Quảng Châu", longitude: 113.26, latitude: 23.13, timezone: 8 },
  { id: "cn-shenzhen", country: "cn", label: "Thâm Quyến", longitude: 114.06, latitude: 22.54, timezone: 8 },
  { id: "cn-chengdu", country: "cn", label: "Thành Đô", longitude: 104.07, latitude: 30.57, timezone: 8 },
  { id: "cn-chongqing", country: "cn", label: "Trùng Khánh", longitude: 106.55, latitude: 29.56, timezone: 8 },
  { id: "cn-wuhan", country: "cn", label: "Vũ Hán", longitude: 114.31, latitude: 30.59, timezone: 8 },
  { id: "cn-xian", country: "cn", label: "Tây An", longitude: 108.94, latitude: 34.34, timezone: 8 },
  { id: "cn-kunming", country: "cn", label: "Côn Minh", longitude: 102.71, latitude: 25.04, timezone: 8 },
  { id: "cn-urumqi", country: "cn", label: "Ürümqi", longitude: 87.62, latitude: 43.83, timezone: 8 },

  // —— Hồng Kông ——
  { id: "hk-hongkong", country: "hk", label: "Hồng Kông", longitude: 114.17, latitude: 22.32, timezone: 8 },
] as const;
